...
class Sentiment extends React.Component {
  ...
  render() {
    return(
      <div style={{ background: 'white', boxShadow: '0 1px 3px rgba(0,0,0,0.12), 0 1px 2px rgba(0,0,0,0.24)', marginBottom: '3%' }}>
        <h2 style={{ textAlign: 'left', padding: '2%' }}>Sentiment Analysis</h2>

        <div style={{ width: '80%', height: '50px', paddingBottom: '1%', margin: 'auto' }}>
          <span style={{ width: this.props.main_sentiment.negative, height: '100%', display: 'inline-block', background: '#b33000', marginRight: '3px' }}>&nbsp;</span>
          <span style={{ width: this.props.main_sentiment.neutral, height: '100%', display: 'inline-block', background: '#A7A9AC' }}>&nbsp;</span>
          <span style={{ width: this.props.main_sentiment.positive, height: '100%', display: 'inline-block', background: '#9acd32', marginLeft: '3px' }}>&nbsp;</span>
